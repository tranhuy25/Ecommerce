      ...
      <footer className='container'>
        ...
        >
          ...
          <Grid xs={12} sm={4} md={3} direction='column' css={{ p: 20 }}>
            ...
            <div className='contactItem'>
              <AiFillPhone color='7828C8' style={{ marginRight: '10px' }} /> 0976892462
            </div>
            <div className='contactItem'>
              <AiFillMail color='7828C8' style={{ marginRight: '10px' }} />{' '}
              vanhuy.tran@aisoft.com.vn
            </div>
          </Grid>
          <Grid xs={12} sm={4} md={3} direction='column' css={{ p: 20 }}>
            <h3 className='title'> Contribution </h3>
            <div className='contactItem'>
              <MdMeetingRoom color='7828C8' style={{ marginRight: '10px' }} />{' '} Nguyen Nguyen Hao   
            </div>
            <div className='contactItem'>
              <MdMeetingRoom color='7828C8' style={{ marginRight: '10px' }} />{' '} Tran Van Huy 
            </div>
            <div className='contactItem'>
              <iframe
